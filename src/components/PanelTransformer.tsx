    ...
    >
      <div>
        ...
        <div className="mt-4 space-y-2.5">
          ...
          <div className="bg-slate-950/90 p-3.5 rounded-2xl border border-slate-800/90 max-h-60 overflow-y-auto space-y-3.5 shadow-inner">
            <div>
      ...
      <div className="bg-slate-950/90 p-4 rounded-2xl border border-slate-800/90 space-y-3.5 shadow-inner">
        ...
        <div className="text-[11px] font-mono text-slate-400 bg-slate-900/80 p-2.5 rounded-xl border border-slate-800/60">
      ...
      <div className="p-3.5 rounded-xl bg-amber-950/40 border border-amber-800/50 flex items-start gap-2.5 text-xs text-amber-200 shadow-md">
