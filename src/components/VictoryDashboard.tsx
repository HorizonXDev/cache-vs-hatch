...
export const VictoryDashboard: React.FC<VictoryDashboardProps> = ({
  ...
  return (
    <div className="bg-gradient-to-b from-slate-900/90 via-slate-900/80 to-slate-950/90 border border-slate-800/90 rounded-2xl p-5 sm:p-6 shadow-2xl space-y-6 backdrop-blur-sm">
      {/* Dashboard Title */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-800/80 pb-4 gap-3">
        ...
        <div className="px-3.5 py-1.5 rounded-xl bg-slate-950/80 border border-slate-800 text-slate-300 text-xs font-mono flex items-center gap-2 shrink-0 flex-wrap shadow-inner">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <motion.div
          ...
          className="bg-slate-950/90 p-4 sm:p-5 rounded-2xl border border-slate-800 hover:border-cyan-500/40 transition-all space-y-3 shadow-lg"
        >
          <div className="flex justify-between items-start">
            <div className="p-2 rounded-xl bg-cyan-500/10 text-cyan-400 border border-cyan-500/30">
              <HardDrive className="w-5 h-5" />
            </div>
            <span className="px-2 py-0.5 rounded-md text-[10px] font-bold font-mono bg-slate-900 text-cyan-300 border border-cyan-500/20">
              COMPUTED LIVE
            </span>
          </div>
          ...
          <div className="space-y-2 pt-2 border-t border-slate-800/80 font-mono text-xs">
            <div className="flex items-center justify-between text-pink-300 font-semibold bg-pink-950/20 px-2.5 py-1 rounded-lg border border-pink-500/20">
              <span>BDH (W):</span>
              <span>{formatBytes(bdhBytes)} (O(1))</span>
            </div>
            <div className="flex items-center justify-between text-cyan-300 font-semibold bg-cyan-950/20 px-2.5 py-1 rounded-lg border border-cyan-500/20">
              <span>KV cache (K,V):</span>
              <span>{formatBytes(kvBytes)} (N={N})</span>
            </div>
            <div className="text-[10px] text-slate-400 leading-relaxed pt-1 font-sans">
        ...
        <motion.div
          whileHover={{ y: -3 }}
          transition={{ type: 'spring', stiffness: 300, damping: 20 }}
          className="bg-slate-950/90 p-4 sm:p-5 rounded-2xl border border-slate-800 hover:border-purple-500/40 transition-all space-y-3 shadow-lg"
        >
          <div className="flex justify-between items-start">
            <div className="p-2 rounded-xl bg-purple-500/10 text-purple-400 border border-purple-500/30">
              <Activity className="w-5 h-5" />
            </div>
            <span className="px-2 py-0.5 rounded-md text-[10px] font-bold font-mono bg-purple-950/80 text-purple-300 border border-purple-500/30">
              CITED PAPER
            </span>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Real BDH property from Pathway paper</p>
          </div>

          <div className="space-y-1.5 pt-2 border-t border-slate-800/80 text-[10px] leading-relaxed text-slate-400">
            <p>
        ...
        <motion.div
          whileHover={{ y: -3 }}
          transition={{ type: 'spring', stiffness: 300, damping: 20 }}
          className="bg-slate-950/90 p-4 sm:p-5 rounded-2xl border border-amber-800/40 hover:border-amber-500/60 transition-all space-y-3 shadow-lg"
        >
          <div className="flex justify-between items-start">
            <div className="p-2 rounded-xl bg-amber-500/10 text-amber-400 border border-amber-500/30">
              <AlertTriangle className="w-5 h-5" />
            </div>
            <span className="px-2 py-0.5 rounded-md text-[10px] font-bold font-mono bg-amber-950 text-amber-300 border border-amber-800/60">
              O(1) TRADE-OFF
            </span>
          </div>

          <div>
            <h3 className="font-bold text-white text-sm">Interference &amp; Memory Decay</h3>
      ...
      <div className="border-t border-slate-800/80 pt-3.5 space-y-1 text-[11px] leading-relaxed text-slate-400 font-mono">
        <p>
